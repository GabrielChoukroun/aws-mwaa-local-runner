...
class SnowTrace:
    ...
    fetchTxList()
        Returns last set of AVAX transactions for the provided address
    ...
    def fetchTransactions(self, address, action, startBlock):
        """
        Returns last set of AVAX transactions for the provided address from a startBlock
