...
class Etherscan:
    """
    Provides methods to fetch data from Etherscan.io
    ...
    -------
    fetchTokenTx()
        Returns last set of ERC20 transactions for the provided address
        
    fetchTxList()
        Returns last set of ETH transactions for the provided address
    ...
    def getETHBalance(self, address):
        """
        Returns ETH balance of {address}
        ...
        <response object>
        """
        return self._executeRequest(module='account', action='balance', address=address, tag='latest')
    ...
    def fetchTransactions(self, address, action, startBlock):
        """
        Returns last set of ETH/ERC20 transactions for the provided address from a startBlock
        ...
        action : str
            Determines which set of transactions: Normal (ETH) or Internal (ERC 20)
